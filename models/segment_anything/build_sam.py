...
#
#     patch_embed = dict_trained['image_encoder.patch_embed.proj.weight']
#     patch_embed = F.interpolate(patch_embed, (patch_size, patch_size), mode='bilinear', align_corners=False)
#     dict_trained['image_encoder.patch_embed.proj.weight'] = patch_embed
#
#
